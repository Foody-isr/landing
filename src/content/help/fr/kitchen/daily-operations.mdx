...
**Operations Quotidiennes** est le centre de commande du fonctionnement quotidien de votre cuisine. Il regroupe le suivi des ventes, la reception des livraisons, le comptage du stock, l'analyse du food cost, le suivi des pertes et la planification des achats dans un seul rapport quotidien.

Chaque jour suit le meme cycle : ouvrir un rapport, enregistrer ce qui s'est passe, cloturer la journee et generer les commandes fournisseurs pour demain.
...
C'est ici que vous comparez ce qui *aurait du* etre utilise (selon les recettes) a ce qui a ete *reellement* utilise (selon les comptages physiques).

### Comment fonctionnent les ecarts

Pour chaque ingredient, le systeme calcule :

- **Stock d'ouverture** = ce que vous aviez au debut de la journee
- **Recu** = livraisons enregistrees pendant la journee
- **Usage theorique** = ce que les recettes indiquent, base sur les ventes
- **Stock de fermeture** = ce que vous comptez physiquement en fin de journee
- **Pertes** = deterioration ou dommages enregistres separement

La formule : **Usage reel** = ouverture + recu - fermeture - pertes

**Ecart** = usage reel - usage theorique
...
Quand vous etes pret, cliquez sur **Cloturer la journee**. Cela declenche plusieurs actions :
...
Apres la cloture, la section **Approvisionnements Estimes** apparait en bas du rapport. Le systeme predit ce que vous devez commander pour demain.

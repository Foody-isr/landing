...
Utilisez le bouton **Afficher HT / Afficher TTC** pour basculer entre les vues avec et sans taxe. Pour un food cost % precis, le systeme normalise les couts et le chiffre d'affaires sur la meme base de TVA. Les articles marques "Prix TTC" sont automatiquement ajustes.

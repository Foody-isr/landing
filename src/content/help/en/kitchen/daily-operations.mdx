...
Use the **Show ex. VAT / Show inc. VAT** toggle to switch between tax-inclusive and tax-exclusive cost views. For accurate food cost %, the system normalizes both costs and revenue to the same VAT basis. Items flagged as "price includes VAT" are automatically adjusted.
